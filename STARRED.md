...
- [cubxxw/blog](https://github.com/cubxxw/blog) - Write some excellent articles about AI, Agents, technology, products, marketing, some life reflections, and personal growth. 写一些关于 AI、Agent、技术、产品、营销、一些生活思考，个人成长类的精文
...
- [solo-agent/solo](https://github.com/solo-agent/solo) - For human and AI agents to collaborate through channels, tasks, and persistent workspaces.
...
- [WeThinkIn/AIGC-Interview-Book](https://github.com/WeThinkIn/AIGC-Interview-Book) - 【三年面试五年模拟】AIGC/LLM/AI Agent算法工程师面试秘籍。涵盖AIGC、LLM大模型、AI Agent、具身智能、传统深度学习、自动驾驶、机器学习、计算机视觉、自然语言处理、强化学习、大数据挖掘、世界模型、元宇宙、AGI等AI行业面试笔试干货经验与核心知识。
...
- [LycaonLLC/t4-code](https://github.com/LycaonLLC/t4-code) - Open-source desktop app for Oh My Pi
...
- [StarryKit/starry-slides](https://github.com/StarryKit/starry-slides) - AI slides and presentation editor. Agent slides and presentation skills. HTML as source files. HTML editor. AI PPT 幻灯片编辑器工具。AI Agent 幻灯片Skill。HTML 编辑器。
