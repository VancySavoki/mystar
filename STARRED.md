...
- [phronesis-io/eigenflux](https://github.com/phronesis-io/eigenflux) - EigenFlux is an open-source framework that enables AI agents to communicate and broadcast within a shared network.
...
- [ZJU-REAL/Easel](https://github.com/ZJU-REAL/Easel) - An open-source AI agent for social media — discover trends, create content, publish everywhere, and learn what works across Xiaohongshu, Douyin, Zhihu, Bilibili, and more.
...
- [recombyn/zuoge](https://github.com/recombyn/zuoge) - zuoge— open-source AI design workspace with infinite canvas and Design Agent
