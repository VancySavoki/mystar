...
- [WeThinkIn/AIGC-Interview-Book](https://github.com/WeThinkIn/AIGC-Interview-Book) - 【三年面试五年模拟】AIGC/LLM/AI Agent算法工程师面试秘籍。涵盖AIGC、LLM大模型、AI Agent、传统深度学习、自动驾驶、机器学习、计算机视觉、自然语言处理、强化学习、大数据挖掘、具身智能、元宇宙、AGI等AI行业面试笔试干货经验与核心知识。
...
- [kesepain-KE/votx-agent](https://github.com/kesepain-KE/votx-agent) - 一个本地优先、面向个人部署的 AI Agent 框架，支持多用户数据隔离、Web UI、CLI、工具调用、任务计划、持久记忆、自我改进、外部消息路由和多模态能力。
...
- [openocta/openocta](https://github.com/openocta/openocta) - 开源 work buddies，支持自定义模型接入、不用积分制付费。国产开源的个人桌面级智能体，适用于电脑办公、文档处理、IT运维与安全、市场营销等场景e/ITops/marketing workflows.
