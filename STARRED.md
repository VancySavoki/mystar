...
- [iforge-go/iforge](https://github.com/iforge-go/iforge) - A self-hosted R&D collaboration platform connecting tasks, code, and delivery — stories, Git, MRs, CI/CD in one workflow.
...
- [stello-agent/agent-connect](https://github.com/stello-agent/agent-connect) - Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LINE, WeChat Work). Chat with your AI dev assistant from
...
- [solo-agent/solo](https://github.com/solo-agent/solo) - Solo Agent — an open-source, local-first workspace where humans and AI coding agents collaborate through channels, tasks, teams, and persistent memory.
...
- [phronesis-io/eigenflux](https://github.com/phronesis-io/eigenflux) - Official repository for EigenFlux — the open-source communication and broadcast network for AI agents.
...
- [UgOrange/vibemux](https://github.com/UgOrange/vibemux) - VibeMux – Orchestrate parallel Claude Code agents in a single TUI
- [blueberrycongee/wuu](https://github.com/blueberrycongee/wuu) - Open-source BYOK AI coding agent with a desktop app, scriptable CLI, and built-in multi-agent orchestration. Written in Go.
...
- [codeany-ai/codeany](https://github.com/codeany-ai/codeany) - Open-source AI-powered terminal agent. Built in Go.
...
- [grafana-cold-storage/beyla-operator](https://github.com/grafana-cold-storage/beyla-operator) - 
...
- [containerd/accelerated-container-image](https://github.com/containerd/accelerated-container-image) - A production-ready remote/on-demand container/sandbox/vm image format (overlaybd) and snapshotter
...
- [marswaveai/skills](https://github.com/marswaveai/skills) - Skills from ListenHub.ai & ColaOS
...
- [happycapy-ai/Happycapy-skills](https://github.com/happycapy-ai/Happycapy-skills) - A curated collection of high-quality Claude Code skills to enhance your development workflow
- [alchaincyf/deepseek-v4-deep-dive](https://github.com/alchaincyf/deepseek-v4-deep-dive) - DeepSeek V4 深度解读 · 73 页 PPT + 20 分钟讲稿 + 发布动画 · Designed with huashu-design
...
- [genspark-ai/clawverse](https://github.com/genspark-ai/clawverse) - 🦞 Clawverse — Build your pixel island, visit friends, collect everything. Built entirely by Genspark AI — 100+ autonomous coding sprints, 17,500 lines of code, zero human-written code.
...
- [databufflabs/databuff](https://github.com/databufflabs/databuff) - DataBuff is an AI-native APM built on Opentelemetry，with multi-agent troubleshooting out of the box.
...
- [anqinou-art/mousecrew](https://github.com/anqinou-art/mousecrew) - A group chat and a work board for CLI coding agents — headless, remote, or in a terminal window you are also using.
...
- [ow2-proactive/automation-dashboard](https://github.com/ow2-proactive/automation-dashboard) - Proactive dashboard for ProActive Workflows & Scheduling
- [ow2-proactive/studio](https://github.com/ow2-proactive/studio) - Workflow Studio for ProActive Workflows & Scheduling
...
- [QoderAI/better-harness](https://github.com/QoderAI/better-harness) - An open-source Harness Engineering platform for coding agents—define harnesses as code, run controlled experiments, inspect evidence, and compare outcomes. Turn task evidence into actionable team and 
...
- [Agentchengfeng/chengfeng-landingpage](https://github.com/Agentchengfeng/chengfeng-landingpage) - Installable video-led homepage hero skill for Claude Code and Codex
- [Icyoung/ufoo](https://github.com/Icyoung/ufoo) - Multi-agent workspace protocol - context sharing, event bus, and coordination for AI agents
...
- [yangchuansheng/visual-ip-illustrations](https://github.com/yangchuansheng/visual-ip-illustrations) - Codex Skill for consistent 16:9 hand-drawn article illustrations with selectable visual IP routes: Openclaw, Xiaohei, Littlebox, Tom, Ferris, Seal and Gopher.
...
- [jackwener/OpenTeamFormat](https://github.com/jackwener/OpenTeamFormat) - Portable format for Raft/Slock team and agent templates
- [AnyGenIO/anygen-skills](https://github.com/AnyGenIO/anygen-skills) - AnyGen AI Skills for AI Agents
...
- [StarryKit/starrykit-plugin](https://github.com/StarryKit/starrykit-plugin) - Free AI presentation maker & free AI poster maker for Codex, Claude Code, Cursor, and more—create editable slides, decks, posters, and social graphics with StarryKit.
...
- [stello-agent/kitkit-desktop](https://github.com/stello-agent/kitkit-desktop) - KitKit Desktop Version
- [aitanjp/flow-x](https://github.com/aitanjp/flow-x) - flow-x
...
- [alchaincyf/loop-engineering-orange-book](https://github.com/alchaincyf/loop-engineering-orange-book) - 别再问我什么是 Loop Engineering — 橙皮书系列。A plain-language guide to loop engineering (中文 + English PDF). Free.
- [dokobot/distill-skill](https://github.com/dokobot/distill-skill) - Scrape any X (Twitter) account and distill the person's thinking patterns into a reusable AI persona skill. Powered by Dokobot.
- [dokobot/skills](https://github.com/dokobot/skills) - Dokobot skills for Claude Code
- [hans0809/MiniMind-in-Depth](https://github.com/hans0809/MiniMind-in-Depth) - 轻量级大语言模型MiniMind的源码解读，包含tokenizer、RoPE、MoE、KV Cache、pretraining、SFT、LoRA、DPO等完整流程
- [helm-agent/helm-agent](https://github.com/helm-agent/helm-agent) - Feedback and issue tracking for Helm
...
- [smallnest/ian-xiaohei-illustrations](https://github.com/smallnest/ian-xiaohei-illustrations) - 中文小黑怪诞正文配图生成 Skill | 16:9 白底手绘 | 少量红橙蓝批注 | Codex Skill
- [kkshinkai/sumink-releases](https://github.com/kkshinkai/sumink-releases) - The go-to infinite canvas app for content creators of all kinds.
...
- [victorzhang016-code/prd-master](https://github.com/victorzhang016-code/prd-master) - 为AI Startup打造的PRD大师。帮你挖需求，说人话，推飞书的PRD助手，以及……一点独门秘笈。
...
- [oil-oil/oil-cover](https://github.com/oil-oil/oil-cover) - 基于真实视频内容生成三种画幅的封面，支持选帧分析、标题设计和可选创作者头像合成。
- [oil-oil/oil-motion](https://github.com/oil-oil/oil-motion) - 设计并实现随滚动、拖动、指针或状态变化响应的网页动画，覆盖素材、时间轴和运行时。
- [semantica-agi/semantica](https://github.com/semantica-agi/semantica) - Graph-Native Infrastructure for Context and Accountable AI Systems
- [gnipbao/codex-whiteboard-video-skill](https://github.com/gnipbao/codex-whiteboard-video-skill) - 
- [hi-nikola/hand-drawn-explainer-video-nikola](https://github.com/hi-nikola/hand-drawn-explainer-video-nikola) - 中文手绘知识讲解视频 Codex Skill：逐笔故事、双语义岛、让怪诞小黑动起来与程序动画
- [ZJU-REAL/Easel](https://github.com/ZJU-REAL/Easel) - An open-source AI agent for social media — discover trends, create content, publish everywhere, and learn what works across Xiaohongshu, Douyin, Zhihu, Bilibili, and more.🎨一个开源的 AI 社交媒体智能体——发现热点趋势、创作内
...
- [agentsea/agentd](https://github.com/agentsea/agentd) - A daemon that makes a desktop OS accessible to AI agents
- [agentsea/agentdesk](https://github.com/agentsea/agentdesk) - A desktop for AI agents
...
- [alchaincyf/huashu-icon-set](https://github.com/alchaincyf/huashu-icon-set) - 端到端为项目生成风格统一图标集 · 默认4×4网格批量生成+逐个精度兜底+智能抠图，Doubao image_gen 驱动 no API fees
- [KKKKhazix/human-writing](https://github.com/KKKKhazix/human-writing) - 让 AI 写的中文读起来像一个具体的人在说话。通用创作与改稿 Skill，开箱即用。
- [ChengxiSHE/Coherens](https://github.com/ChengxiSHE/Coherens) - Codex-native coordination and knowledge accumulation for multi-endpoint, multi-project engineering.
...
- [renmengwen/InkCue](https://github.com/renmengwen/InkCue) - 
...
- [Hchen1218/heytea-style](https://github.com/Hchen1218/heytea-style) - Make your photo look like a Heytea style poster
...
- [Praison-Labs/Praison](https://github.com/Praison-Labs/Praison) - Praison is a production-ready framework for building multi-agent AI systems that enables intelligent agents to collaborate, reason, self-reflect, and use tools to automate tasks, with support for over
...
- [datar-gaurav/sutra-os](https://github.com/datar-gaurav/sutra-os) - Open-source AI agent orchestration platform. Multi-agent discussions, visual workflows, 30+ tools, human-in-the-loop governance.
...
- [JuneQQQ/polynoia](https://github.com/JuneQQQ/polynoia) - Make AI agents work like real teammates—taking ownership, collaborating, and delivering results.
...
- [KroMiose/nekro-agent](https://github.com/KroMiose/nekro-agent) - NekroAgent 是一个面向多人互动场景的跨平台 Agent 框架，集 Claude Code 沙盒执行、工作区编排、长期记忆、结构化 MCP 管理与可视化控制台于一体，兼具高扩展性、多模态交互、实时状态推送和自动化运行能力。项目支持 QQ、Discord、Telegram、Minecraft、BilibiliLive、WeChat、Email、SSE(SDK) 等多种平台接入，应用于构建高智
- [Rath-Team/OpenRath](https://github.com/Rath-Team/OpenRath) - An open-source, PyTorch-like runtime for dynamic multi-agent and multi-session workflows.
- [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) - Academic Research Skills for Claude Code: research → write → review → revise → finalize
- [kesepain-KE/votx-agent](https://github.com/kesepain-KE/votx-agent) - 面向个人部署的 AI Agent 框架，支持多用户数据隔离、Web UI、CLI、工具调用、任务计划、持久记忆、自我改进、外部消息路由和多模态能力。
...
- [AIPMAndy/CEOskill](https://github.com/AIPMAndy/CEOskill) - CEO decision-support skill for AI agents: strategy, trade-offs, debiasing, stakeholder mapping, and war gaming
...
- [kingsa2026/QwenPaw_HumanThinking_plugin](https://github.com/kingsa2026/QwenPaw_HumanThinking_plugin) - QwenPaw插件 - 人类思维模拟与记忆管理,具有睡眠机制，合并相似记忆和解决矛盾记忆，跨Session碎片记忆整合，保持agent记忆连续性
- [liuxigreen/agenthansabot](https://github.com/liuxigreen/agenthansabot) - agenthansabot
...
- [modelscope/ultron](https://github.com/modelscope/ultron) - Ultron: Collective Intelligence System — Shared Memories, Skills, and Harnesses Across Every Agent
...
- [Haohao-end/openagent](https://github.com/Haohao-end/openagent) - What if OpenAI Deep Research and Dify were one platform? OpenAgent — harness architecture for rapidly building vertical AI agents, with deep reasoning loops, visual workflows, RAG, and A2A delegation.
...
- [jd-opensource/OxyGent](https://github.com/jd-opensource/OxyGent) - [ACL 2026] OxyGent: Making Multi-Agent Systems Modular, Observable, and Evolvable via Oxy Abstraction https://arxiv.org/abs/2604.25602
...
- [DaoCloud/DaoCloud-docs](https://github.com/DaoCloud/DaoCloud-docs) - DaoCloud Documentation
...
- [RealZST/HarnessKit](https://github.com/RealZST/HarnessKit) - More than a skill manager — manage skills, MCP servers, plugins, hooks, CLIs, configs, memory & rules across every AI coding agent. 🌟 Star if you like it!
...
- [Ericwong5021/better-codex](https://github.com/Ericwong5021/better-codex) - A task board and Agent system inside Codex Desktop. Local-first, open source, macOS and Windows.
- [wwaa321/kiko-workbench](https://github.com/wwaa321/kiko-workbench) - Agent 能力自进化工作台：Agent 按业务需求现场开发插件（内置 Plugin SDK Distributor，零 shell 自举），任何 Agent 经标准 JSON-RPC / MCP 即插即用。
- [talesofai/cohub](https://github.com/talesofai/cohub) - A living space where people and agents create, play, and build together.
- [jeremy-prt/bloub](https://github.com/jeremy-prt/bloub) - SVG recreation of the x.ai bot avatar. One shape morphing through 14 states, measured off the reference video frame by frame.
...
- [zhuwenzhuang/farming](https://github.com/zhuwenzhuang/farming) - Farming Code is a self-hosted browser workspace for running and supervising Codex, Claude Code, OpenCode, and other AI coding agents.
...
- [Sunyuanrui915/FlowShuttle](https://github.com/Sunyuanrui915/FlowShuttle) - Flow Shuttle is a local-first desktop journal for tracking personal work progress across projects, daily notes, reports, and heatmaps.
- [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) - Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi-engine workspace for Codex Harness, DeepSeek Harness, and OpenCode, with unified plugins and Skills, multi-age
...
- [cytostack/openwolf](https://github.com/cytostack/openwolf) - Portable project memory across Claude Code, Codex and OpenCode, plus token accounting measured from harness transcripts. Local file I/O, no API calls, no telemetry.
...
- [molefrog/moi](https://github.com/molefrog/moi) - 💾 MOI: agent-agnostic generative UI workspace. Give your agent a skill and let it build software around itself.
- [kgoedecke/doop](https://github.com/kgoedecke/doop) - The open-source alternative to Paper.design. A multiplayer design canvas where humans and AI agents design together, live. MCP built in.
...
- [openTrinity/mycontext](https://github.com/openTrinity/mycontext) - MyContext is a local-first desktop app for everyday communication and knowledge work
...
- [QoderAI/forward-quickstart](https://github.com/QoderAI/forward-quickstart) - 
...
- [BiglionX/NvwaX](https://github.com/BiglionX/NvwaX) - NvwaX 全栈 AI Agent 平台 功能：  搜索全网 AI Agent  团队协作模板 ⚡ 智能工作流 🎁 悬赏任务系统
...
- [sunyifeisb-art/legalwork](https://github.com/sunyifeisb-art/legalwork) - LegalWork - legal AI workbench
...
- [OctaFuse/octafuse-gateway](https://github.com/OctaFuse/octafuse-gateway) - Octafuse Gateway是可自托管的开源 AI Gateway：把多供应商、多账号、多 API Key 收成一个 Base URL、一个 API Key，并带路由、预算、计费与审计。
- [OneUptime/oneuptime](https://github.com/OneUptime/oneuptime) - Complete open-source monitoring and observability platform.
- [WrongStack/WrongStack](https://github.com/WrongStack/WrongStack) - An AI coding agent that reads your code, edits files, runs commands, and reasons through bugs — across a terminal REPL, a full-screen TUI, and a browser UI, while you keep your hand on every permissio
- [ensaktas1/icones-desktop](https://github.com/ensaktas1/icones-desktop) - Native macOS icon browser for the Iconify ecosystem — 200k+ icons, built with Tauri + React
- [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) - Teams-first Multi-agent orchestration for Claude Code
- [arul28/ADE](https://github.com/arul28/ADE) - 
...
- [stello-agent/stello](https://github.com/stello-agent/stello) - Conversations aren't linear — why should AI chats be? The first open-source conversation topology engine. Auto-branching session trees, inherited memory, star-map visualization. Build agents that reme
...
- [Aho1ic/Aeroric](https://github.com/Aho1ic/Aeroric) - A desktop task manager for AI coding agents like Claude Code and Codex, with multi-project workspaces, live terminals, session tracking, permission-aware execution, Git integration, and usage analytic
- [microsoft/Huabu](https://github.com/microsoft/Huabu) - Huabu, where you and your agents think together.
- [agentteamhq/agentteam-email](https://github.com/agentteamhq/agentteam-email) - Open-source email infrastructure for AI agents.
...
- [nexmoe/eve](https://github.com/nexmoe/eve) - Eve Recorder: A cross-platform long-running microphone recorder with real-time transcription. It uses Qwen3-ASR by default. VAD keeps only speech segments and transcribes speech-only chunks.
- [Gitlawb/openclaude](https://github.com/Gitlawb/openclaude) - runs anywhere. uses anything
- [poe-platform/poe-code](https://github.com/poe-platform/poe-code) - Use Poe to power your favorite coding agents (Claude Code, Codex, OpenCode, etc). No need for multiple subscriptions.
- [wfnuser/cowiki](https://github.com/wfnuser/cowiki) - LLM Wiki, but multiplayer
...
- [tigicion/dao-code](https://github.com/tigicion/dao-code) - Open-source TypeScript terminal coding agent for DeepSeek-V4 — builds on DeepSeek's strong price-performance and ultra-cheap cache pricing, engineering byte-stable prefixes and cache-reusing forks so 
...
- [kzahel/yepanywhere](https://github.com/kzahel/yepanywhere) - Self-hosted web UI for Claude and Codex. Push notifications, file uploads, no accounts, no database. Uses your existing CLI session history.
...
- [vercel/sandbox](https://github.com/vercel/sandbox) - Vercel Sandbox is an ephemeral compute primitive designed to safely run untrusted or user-generated code.
...
- [MatrixAges/polywise](https://github.com/MatrixAges/polywise) - The open source agentic content system to make your contents alive. Self-hosted on any platform. ◑
...
- [agentspan-ai/agentspan](https://github.com/agentspan-ai/agentspan) - Agentspan is now part of Orkes Conductor
...
- [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm) - Your Company Agentic Operating System
...
- [osvald-go2/meka-flow](https://github.com/osvald-go2/meka-flow) - 
- [AIDotNet/MoYuCode](https://github.com/AIDotNet/MoYuCode) - 
...
- [linkerlin/PUAX](https://github.com/linkerlin/PUAX) - 用来驯服AI Agent的效果绝佳的多角色 Prompt  SKILLs！
...
- [react-component/drawer](https://github.com/react-component/drawer) - 🚪 Accessible React drawer component with portal rendering, masks, nested push behavior, keyboard close handling, focus management, and optional resizable panels.
...
- [react-component/footer](https://github.com/react-component/footer) - 🦶 Footer primitives for React, maintained in the Ant Design ecosystem.
